...
void ListPopupMenu::insert(const MenuType m, KMenu* menu)
{
    ...
    case mt_InterfaceProvided: m_actions[m] = menu->addAction(Icon_Utils::SmallIcon(Icon_Utils::it_Interface), i18n("Provided interface")); break;
    case mt_InterfaceRequired: m_actions[m] = menu->addAction(Icon_Utils::SmallIcon(Icon_Utils::it_Interface), i18n("Required interface")); break;
